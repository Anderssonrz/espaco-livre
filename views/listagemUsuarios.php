...
if (isset($_POST['btnPesquisarUsuarios'])) {
    ...
    $sql_pesquisa = "SELECT * FROM `usuarios`";
}
$resultado = $conexao->query($sql_pesquisa);

if (isset($_POST['btnRetornar'])) {
    header("refresh: url=listagemUsuarios.php");
}
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    <form action="" method="POST" class="form-inline">
                        <label for="id_usuario" class="form-label"><b>Pesquisar Usuário por ID:</b></label><br>
                        <div class="input-group">
                            <input type="number" class="form-control" name="id_usuario" id="id_usuario" placeholder="ID do usuário" />
    ...
    function listarUsuarios($conexao, $sql_pesquisa)
    {
        ...
        while ($linha = mysqli_fetch_assoc($result)) {
            ...
            echo "<td> 
                    ...
                    <a class='btn btn-sm btn-danger' href='deleteUsuario.php?id=" . $linha['id'] . "' id='deletar' title='Delete'>
